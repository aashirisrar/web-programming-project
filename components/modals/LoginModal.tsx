...
const LoginModal = () => {
  ...
  const footerContent = (
    <div className="flex flex-col gap-2 md:gap-4 md:mt-3">
      <hr />
      <ButtonRed
        outline
     ...
     mt-1 md:mt-4 font-light"
      >
        <div className="justify-center flex md:flex-row flex-col items-center gap-1 md:gap-2">
          <div className="truncate text-sm md:text-md">
            First time using LinksHubb?
          </div>
          <div
            onClick={toggle}
            className="text-neutral-800 dark:text-neutral-200 truncate text-sm md:text-md
